...
if (isset($_POST['enviar1']) && strtolower($_POST['respuesta1']) == 'hac' && strtolower($_POST['respuesta1_1']) == 'k') {
...
// Reto1 -> Reto2
else if (isset($_POST['enviar2']) && strtolower($_POST['respuesta2']) == '192.168.1.1' && $_POST['mascara2'] == '255.255.0.0'){
    // Recupero la sesión
    session_start();
...
// Reto2 -> Reto3
else if (isset($_POST['enviar3']) && strtolower($_POST['respuesta3']) == 'hello world' && $_POST['desplazamiento'] == -3){
    // Recupero la sesión
    session_start();
...
// Reto3 -> Reto4
else if (isset($_POST['enviar4']) && strtolower($_POST['respuesta4']) == 'hacker'){
    // Recupero la sesión
    session_start();
